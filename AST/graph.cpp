...
void exNode( nodeType *p,  int c, int l, /* start column and line of node */  int *ce, int *cm /* resulting end column and mid of node */)
{
	...
	*/
	...
	switch(p->type) 
	{
		...
		case typeOpr: //sprintf(word, "lol");break;
		switch(p->opr.oper)
		{
			case FOR: s = "for"; break;
			case ALERT: s = "alert"; break;
			case DO:  s = "do-while" ; break;
			case WHILE: s = "while"; break;
			case SWITCH: s = "switch"; break;
			case CASE: s = "case" ;break;
			case DEFAULT: s ="default"; break;
			//case BREAK:   s ="break"; break; doesnt get printed ??
			case ';': {if(flag == 0) {s = "root"; flag = 1;} else if(flag == 2) {s = "global"; flag = 1;} else {s = "[;]";} break;}
			case '=': s = "[=]"; break;
